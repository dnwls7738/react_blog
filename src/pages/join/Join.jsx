                ...
                <fieldset>
                    ...
                    <div className="join-box">
                        ...
                        <div>
                            ...
                            <input type="password" id="youPassC" name="youPassC" placeholder="다시 비밀번호를 적어주세요!" autoComplete="off" required />
                        </div>
                        <div>
                        ...
                        <div>
                            ...
                            <input type="text" id="youBirth" name="youBirth" placeholder="YYYY-MM-DD" autoComplete="off" required />
                        </div>
                        <div>
                            <label htmlFor="youPhone">휴대폰 번호</label>   
                            <input type="text" id="youPhone" name="youPhone" placeholder="000-0000-0000" autoComplete="off" required />
                        </div>
                    </div>
